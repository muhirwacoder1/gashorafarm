...
export const AddProduct: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    stock: '',
    harvestDate: '',
    imageUrl: 'https://images.unsplash.com/photo-1597362925123-77861d3fbac7?auto=format&fit=crop&q=80', // Default mock image
    isOrganic: true
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
        const newProduct: Product = {
            ...
            farmerId: 'f1', // Hardcoded as logged in user
            name: formData.name,
    ...
    <div className="min-h-screen pt-32 pb-20 bg-stone-50">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-stone-100">
                <h3 className="mb-6 text-xl font-bold text-stone-900">Photos</h3>
                <div className="rounded-2xl border-2 border-dashed border-stone-300 bg-stone-50 p-12 text-center hover:bg-stone-100 transition-colors cursor-pointer">
                    <Upload className="mx-auto h-12 w-12 text-stone-400" />
                    <p className="mt-4 text-sm font-medium text-stone-500">Click to upload or drag and drop</p>
